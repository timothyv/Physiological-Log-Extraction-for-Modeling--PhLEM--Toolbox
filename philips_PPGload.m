function [signal, time] = philips_PPOload2(fname,varargin)

%function [ppo time] = PPO_load(fname, optname, optval);
%
% A loader for the Peripheral Pulse Ox data coming off of the Philips 3T system.
%  
%   INPUT:
